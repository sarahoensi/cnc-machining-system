...
impl SolveCuttingDataUseCase {
    ...
    pub fn execute(
        ...
        let result = match input {
            ...
            SolveCuttingDataInput::FromCuttingSpeed {
                ...
                let rpm =
                    SpindleSpeedCalculator::rpm_from_cutting_speed(vc, diameter)?;

                let feed =
                    FeedRateCalculator::feed_rate_from_chip_load(
                        chip,
                        rpm,
                        teeth,
                    )?;
            ...
            SolveCuttingDataInput::FromRpm {
                ...
                let vc =
                    SpindleSpeedCalculator::cutting_speed_from_rpm(
                        rpm,
                        diameter,
                    )?;
            ...
            SolveCuttingDataInput::FromFeedRate {
                ...
                let chip =
                    ChipLoadCalculator::chip_load_from_feed_rate(
                        feed,
                        rpm,
                        teeth,
                    )?;
    ...
    fn to_output(
        (vc, rpm, chip, feed): (CuttingSpeed, Rpm, ChipLoad, FeedRate),
    ) -> SolveCuttingDataOutput {
